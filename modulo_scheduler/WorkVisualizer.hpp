...
private:
 ...
 WorkVisualizer(int width, int height):size_x(0),size_y(0),work_itens(nullptr),width(width),height(height){  
    ...
    void update(int _i,int _j) {
        ...
        //int j = _j;
        {
            ...
            if (work_itens[ij] == -1) {
                ...
                SDL_SetRenderDrawColor(gRenderer, 0xFF,0xFF - 20 * work_itens[ij],0x10 + 20* work_itens[ij] , 0xFF );
            }
